          ...
          <div className="lg:absolute bottom-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4">
              {packages.map((pkg, index) => (
                <div
                  key={index}
                  className="bg-white hover:bg-[#2727aa] hover:text-white transition duration-100 text-black rounded-lg shadow-lg p-6 flex flex-col justify-between text-center"
                >
                  <div>
                  ...
                  <Link to={'/new-ticket'}>
                    <button className="bg-[#2E4CB9] text-white py-2 px-4 rounded-lg shadow-md hover:bg-white hover:text-blue-500 transition mt-auto">
                      {pkg.buttonLabel}
                    </button>
                  </Link>
                </div>
